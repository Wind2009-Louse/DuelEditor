...
class Ui_MainWindow(QWidget):
    def labelset(self):
        ...
        self.label_self_hands = QLabel(self.DuelFrame)
        self.label_self_hands.setGeometry(QRect(50, 470, 81, 20))
        self.label_self_hands.setObjectName("label_self_hands")
        self.label_self_hands_2 = QLabel(self.DuelFrame)
        self.label_self_hands_2.setGeometry(QRect(260, 470, 81, 20))
        ...
        self.label_self_hands_14 = QLabel(self.DuelFrame)
        self.label_self_hands_14.setGeometry(QRect(480, 470, 81, 20))
        self.label_self_hands_14.setObjectName("label_self_hands_14")
        self.label_self_hands_15 = QLabel(self.DuelFrame)
        self.label_self_hands_15.setGeometry(QRect(690, 470, 81, 20))
        ...
        self.label_self_hands_17 = QLabel(self.DuelFrame)
        self.label_self_hands_17.setGeometry(QRect(480, 10, 81, 20))
        self.label_self_hands_17.setObjectName("label_self_hands_17")
        self.label_self_hands_4 = QLabel(self.DuelFrame)
        self.label_self_hands_4.setGeometry(QRect(260, 10, 81, 20))
        self.label_self_hands_4.setObjectName("label_self_hands_4")
        self.label_self_hands_12 = QLabel(self.DuelFrame)
        self.label_self_hands_12.setGeometry(QRect(50, 10, 81, 20))
        self.label_self_hands_12.setObjectName("label_self_hands_12")
        self.label_self_hands_20 = QLabel(self.DuelFrame)
        self.label_self_hands_20.setGeometry(QRect(690, 10, 81, 20))
        ...
        self.label_self_hands_21 = QLabel(self.DuelFrame)
        self.label_self_hands_21.setGeometry(QRect(30, 240, 81, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_self_hands_14.setText("己方墓地")
        self.label_self_hands_15.setText("己方除外")
        self.label_self_hands_16.setText("对方右灵摆")
        self.label_self_hands_18.setText("对方场地")
        self.label_self_hands_19.setText("对方左灵摆")
        self.label_self_hands_21.setText("对方基本分")
        self.label_self_hands_17.setText("对方墓地")
